...
--------------------------------------------------------------------
--------------------------------------------------------------------
----- Tests for totalBetti2.
--------------------------------------------------------------------
--------------------------------------------------------------------
TEST ///
    assert ((totalBetti2(3,1,0))#(1,{2},2) == 3)
///

TEST ///
    assert ((totalBetti2(5,2,0))#(13,{15},15) == 2002)
///

TEST ///
    assert ((totalBetti2(4,2,2))#(5,{5},5) == 252)
///
...
--------------------------------------------------------------------
TEST ///
    assert ((totalBetti2(3,1,0)) == makeBettiTally (totalBetti(3,1,0)))
///

TEST ///
    assert ((totalBetti2(5,2,0)) == makeBettiTally (totalBetti(5,2,0)))
///

TEST ///
    assert ((totalBetti2(4,2,2)) == makeBettiTally (totalBetti(4,2,2)))
///
...
--------------------------------------------------------------------
--------------------------------------------------------------------
----- Tests for errorBetti.
--------------------------------------------------------------------
--------------------------------------------------------------------
TEST ///
    assert ((errorBetti(3,1,0))#(1,1) == 0)
///

TEST ///
    assert ((errorBetti(5,2,0))#(13,2) == 0)
///

TEST ///
    assert ((errorBetti(4,2,2))#(5,0) == 0)
///

TEST ///
    f = last terms (errorBetti(6,2,3))#(8,0);
    g = -11*t_0^(12)*t_1^(14)*t_2^(25);
    assert (f == g)
///
...
--------------------------------------------------------------------
TEST ///
    assert (rangeCheck(4,2,3) == (true, null))
///

TEST ///
    assert ((rangeCheck(4,2,6))#0 == false)
///

TEST ///
    assert ((rangeCheck(4,5,0))#0 == false)
///
