...
apply(validData,L->(
	L,
	applyPairs(schurBetti(0,L#0,L#1),(k,v)->(
	if #v == 1 then k=>v
	else null
	))
))
...
apply(validData,L->(
	if #(schurBetti(0,L#0,L#1))#(0,0) != 1 then (L,(schurBetti(0,L#0,L#1))#(0,0))
	else null
	))

totalBettiTally(0,{1,4},{3,5})
makeBettiTally numReps(0,{1,4},{3,5})

makeBettiTally applyValues(schurBetti(0,{1,4},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{1,3},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{1,2},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{1,4},{3,5}),length)

makeBettiTally applyValues(schurBetti(0,{2,4},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{2,3},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{2,2},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{2,1},{3,5}),length)



makeBettiTally applyValues(schurBetti(0,{0,0},{3,3}),length)
(schurBetti(0,{0,0},{3,3}))#(11,1)
   
makeBettiTally applyValues(schurBetti(0,{0,0},{3,4}),length)
(schurBetti(0,{0,0},{3,4}))#(11,1)
    
makeBettiTally applyValues(schurBetti(0,{0,0},{3,5}),length)
makeBettiTally applyValues(schurBetti(0,{0,0},{2,3}),length)
(schurBetti(0,{0,0},{2,3}))#(8,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{2,4}),length)
(schurBetti(0,{0,0},{2,4}))#(11,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{2,5}),length)
(schurBetti(0,{0,0},{2,5}))#(14,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{2,6}),length)
(schurBetti(0,{0,0},{2,6}))#(17,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{2,7}),length)
(schurBetti(0,{0,0},{2,7}))#(20,1)
...
(schurBetti(0,{0,0},{1,3}))#(5,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{1,4}),length)
(schurBetti(0,{0,0},{1,4}))#(7,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{1,5}),length)
(schurBetti(0,{0,0},{1,5}))#(9,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{1,6}),length)
(schurBetti(0,{0,0},{1,6}))#(11,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{1,7}),length)


makeBettiTally applyValues(schurBetti(0,{0,0},{3,2}),length)

makeBettiTally applyValues(schurBetti(0,{0,0},{3,3}),length)
(schurBetti(0,{0,0},{3,3}))#(11,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{3,4}),length)
(schurBetti(0,{0,0},{3,4}))#(15,1)

makeBettiTally applyValues(schurBetti(0,{0,0},{3,5}),length)
(schurBetti(0,{0,0},{3,5}))#(19,1)



makeBettiTally applyValues(schurBetti(0,{0,0},{3,6}),length)
(schurBetti(0,{0,0},{1,6}))#(11,1)
...
(schurBetti(0,{0,0},{1,7}))#(13,1)
(schurBetti(0,{0,0},{1,8}))#(15,1)

3/2(x-2)^2+9/2(x-2)+4


(schurBetti(0,{0,0},{2,2}))#(5,1)
