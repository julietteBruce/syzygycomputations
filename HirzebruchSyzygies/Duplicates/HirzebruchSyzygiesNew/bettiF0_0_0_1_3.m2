...
dmw0013 = new HashTable from {(5,2) => {}, (6,1) => {}, (7,1) => {}, (0,0) => {}, (1,0) => {}, (1,1) => {{2,0,4,2}}, (2,0) => {}, (2,1) => {{2,1,6,3},{3,0,5,4}}, (3,0) => {}, (2,2) => {}, (3,1) => {{3,1,7,5},{4,0,5,7}}, (4,0) => {}, (3,2) => {}, (5,0) => {}, (4,1) => {{3,2,8,7},{4,1,7,8}}, (4,2) => {}, (5,1) => {{4,2,8,10}}};
end;